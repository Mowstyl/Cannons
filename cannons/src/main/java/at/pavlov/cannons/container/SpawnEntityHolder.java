                                ...
                                for (String arg : effect.replaceAll("[{}]", "").split(",")) {
                                    ...
                                    if (s3.length > 1) {
                                        ...
                                        switch (s3[0].toLowerCase()) {
                                            ...
                                            default -> System.out.println("[Cannons] '" + s3[0] + "' is not a correct potion effect argument. See Bukkit PotionType");
                                        }
                                    }
                                }
                                Cannons
                                        .getPlugin()
                                        .logDebug("AREA OF EFFECT CLOUD potion type: " + type + " duration " + duration + " amplifier " + amplifier + " ambient " + ambient + " particles " + particles + " icon " + icon);
