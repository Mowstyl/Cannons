...
public class Projectile implements Cloneable {
    ...
    public Particle getSmokeTrailParticleType() {
        return smokeTrailParticleType;
    }
    ...
    public int getSmokeTrailParticleCount() {
        return smokeTrailParticleCount;
    }
    ...
    public double getSmokeTrailParticleOffsetX() {
        return smokeTrailParticleOffsetX;
    }
    ...
    public double getSmokeTrailParticleOffsetY() {
        return smokeTrailParticleOffsetY;
    }
    ...
    public double getSmokeTrailParticleOffsetZ() {
        return smokeTrailParticleOffsetZ;
    }
    ...
    public double getSmokeTrailParticleSpeed() {
        return smokeTrailParticleSpeed;
    }
