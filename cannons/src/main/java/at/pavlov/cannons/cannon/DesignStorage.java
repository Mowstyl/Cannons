...
public class DesignStorage {
    ...
    private void loadDesignYml(CannonDesign cannonDesign, String ymlFile) {
        ...
        cannonDesign.setAutoloadChargeWhenLoadingProjectile(cannonDesignConfig.getBoolean(
                "ammunition.autoloadChargeWhenLoadingProjectile",
                false
        ));
        ...
        // angles
        cannonDesign.setDefaultHorizontalFacing(BlockFace.valueOf(cannonDesignConfig
                .getString("angles.defaultHorizontalFacing", "NORTH")
                .toUpperCase()));
        ...
        cannonDesign.setAutomaticTemperatureControl(cannonDesignConfig.getBoolean(
                "heatManagement.automaticTemperatureControl",
                false
        ));
        ...
        cannonDesign.setItemCoolingUsed(CannonsUtil.toItemHolderList(cannonDesignConfig.getStringList(
                "heatManagement.coolingItemsUsed")));
        if (cannonDesign.getItemCooling().size() != cannonDesign.getItemCoolingUsed().size()) {
            plugin.logSevere(
                    "CoolingItemsUsed and CoolingItems lists must have the same size. Check if both lists have the same number of entries");
        }
        ...
        cannonDesign.setOverloadingChanceOfExplosionPerGunpowder(cannonDesignConfig.getDouble(
                "overloading.chanceOfExplosionPerGunpowder",
                0.01));
        ...
        cannonDesign.setPermissionTargetTracking(cannonDesignConfig.getString(
                "permissions.targetTracking",
                "cannons.player.targetTracking"
        ));
        cannonDesign.setPermissionRedstone(cannonDesignConfig.getString("permissions.redstone", "cannons.player.redstone"));
        cannonDesign.setPermissionThermometer(cannonDesignConfig.getString(
                "permissions.thermometer",
        ...
        cannonDesign.setPermissionSpreadMultiplier(cannonDesignConfig.getString(
                "permissions.spreadMultiplier",
                "cannons.player.spreadMultiplier"
        ));
        ...
        cannonDesign.setSoundDestroy(new SoundHolder(cannonDesignConfig.getString("sounds.destroy",
                "ENTITY_ZOMBIE_ATTACK_IRON_DOOR:1:0.5")));
        cannonDesign.setSoundDismantle(new SoundHolder(cannonDesignConfig.getString(
                "sounds.dismantle",
                "BLOCK_ANVIL_USE:1:0.5"
        )));
        cannonDesign.setSoundAdjust(new SoundHolder(cannonDesignConfig.getString("sounds.adjust",
                "ENTITY_IRON_GOLEM_STEP:1:0.5")));
        cannonDesign.setSoundIgnite(new SoundHolder(cannonDesignConfig.getString("sounds.ignite", "ENTITY_TNT_PRIMED:5:1")));
        cannonDesign.setSoundFiring(new SoundHolder(cannonDesignConfig.getString("sounds.firing",
                "ENTITY_GENERIC_EXPLODE:20:1.5")));
        cannonDesign.setSoundGunpowderLoading(new SoundHolder(cannonDesignConfig.getString("sounds.gunpowderLoading",
                "BLOCK_SAND_HIT:1:1.5")));
        cannonDesign.setSoundGunpowderOverloading(new SoundHolder(cannonDesignConfig.getString("sounds.gunpowderOverloading",
                "BLOCK_GRASS_HIT:1:1.5")));
        ...
        cannonDesign.setSoundRamrodCleaning(new SoundHolder(cannonDesignConfig.getString("sounds.ramrodCleaning",
                "BLOCK_SNOW_HIT:0.5:0")));
        cannonDesign.setSoundRamrodCleaningDone(new SoundHolder(cannonDesignConfig.getString("sounds.ramrodCleaningDone",
                "BLOCK_SNOW_HIT:0.5:1")));
        cannonDesign.setSoundRamrodPushing(new SoundHolder(cannonDesignConfig.getString("sounds.ramrodPushing",
                "BLOCK_STONE_HIT:0.5:0")));
        cannonDesign.setSoundRamrodPushingDone(new SoundHolder(cannonDesignConfig.getString("sounds.ramrodPushingDone",
                "BLOCK_ANVIL_LAND:0.5:0")));
        cannonDesign.setSoundThermometer(new SoundHolder(cannonDesignConfig.getString("sounds.thermometer",
                "BLOCK_ANVIL_LAND:1:1")));
        cannonDesign.setSoundEnableAimingMode(new SoundHolder(cannonDesignConfig.getString("sounds.enableAimingMode",
                "NONE:1:1")));
        cannonDesign.setSoundDisableAimingMode(new SoundHolder(cannonDesignConfig.getString("sounds.disableAimingMode",
                "NONE:1:1")));
        cannonDesign.setSoundSelected(new SoundHolder(cannonDesignConfig.getString("sounds.selected", "BLOCK_ANVIL_LAND:1:2")));

        // constructionBlocks
        cannonDesign.setSchematicBlockTypeIgnore(CannonsUtil.createBlockData(cannonDesignConfig.getString(
                "constructionBlocks.ignore",
                "minecraft:sand"
        )));
        cannonDesign.setSchematicBlockTypeMuzzle(CannonsUtil.createBlockData(cannonDesignConfig.getString(
                "constructionBlocks.muzzle",
                "minecraft:snow_block"
        )));
        cannonDesign.setSchematicBlockTypeFiringIndicator(CannonsUtil.createBlockData(cannonDesignConfig.getString(
                "constructionBlocks.firingIndicator",
                "minecraft:torch"
        )));
        cannonDesign.setSchematicBlockTypeRotationCenter(CannonsUtil.createBlockData(cannonDesignConfig.getString(
                "constructionBlocks.rotationCenter",
                "minecraft:redstone_ore"
        )));
        cannonDesign.setSchematicBlockTypeChestAndSign(CannonsUtil.createBlockData(cannonDesignConfig.getString(
                "constructionBlocks.chestAndSign",
                "minecraft:oak_wall_sign"
        )));
        cannonDesign.setSchematicBlockTypeRedstoneTorch(CannonsUtil.createBlockData(cannonDesignConfig.getString(
                "constructionBlocks.redstoneTorch",
                "minecraft:redstone_torch"
        )));
        cannonDesign.setSchematicBlockTypeRedstoneWireAndRepeater(CannonsUtil.createBlockData(cannonDesignConfig.getString(
                "constructionBlocks.restoneWireAndRepeater",
                "minecraft:repeater"
        )));
        // RedstoneTrigger
        cannonDesign.setSchematicBlockTypeRedstoneTrigger(CannonsUtil.createBlockData(cannonDesignConfig.getString(
                "constructionBlocks.redstoneTrigger.schematic",
                "minecraft:lever"
        )));
        cannonDesign.setIngameBlockTypeRedstoneTrigger(CannonsUtil.createBlockData(cannonDesignConfig.getString(
                "constructionBlocks.redstoneTrigger.ingame",
                "minecraft:stone_button"
        )));
        // rightClickTrigger
        cannonDesign.setSchematicBlockTypeRightClickTrigger(CannonsUtil.createBlockData(cannonDesignConfig.getString(
                "constructionBlocks.rightClickTrigger.schematic",
                "minecraft:torch"
        )));
        cannonDesign.setIngameBlockTypeRightClickTrigger(CannonsUtil.createBlockData(cannonDesignConfig.getString(
                "constructionBlocks.rightClickTrigger.ingame",
                "minecraft:torch"
        )));
        // protected Blocks
        cannonDesign.setSchematicBlockTypeProtected(CannonsUtil.toBlockDataList(cannonDesignConfig.getStringList(
                "constructionBlocks.protectedBlocks")));
    }
        ...
        for (int i = 0; i < 4; i++) {
            ...
            for (SimpleBlock sblock : schematiclist) {
                ...
                // #############  rightClickTrigger
                    ...
                    {
                        cannonBlocks.getChestsAndSigns().add(new SimpleBlock(
                                x,
                                y,
                                z,
                                sblock.getBlockData()
            ...
            Vector compensation = new Vector(
                    cannonBlocks.getMuzzle().getBlockX(),
                    cannonBlocks.getMuzzle().getBlockY(),
                    cannonBlocks.getMuzzle().getBlockZ()
            );
